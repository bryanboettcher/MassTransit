namespace MassTransit.Dapper.MySqlql.Formatting
{
    ...
    public class PessimisticMySqlSagaFormatter<TModel> : SagaFormatterBase, ISagaSqlFormatter<TModel>
        where TModel : class, ISaga
    {
        readonly string _tableName;
        readonly string _idColumnName;

        public PessimisticMySqlSagaFormatter(string? tableName = null, string? idColumnName = null)
        {
