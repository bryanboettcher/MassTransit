namespace MassTransit.Persistence.Integration.JobSagas
{
        ...
        where TModel : class, ISaga
    {
        ...
        readonly SagaSerializer<TSaga, TModel> _serializer;

        protected JobSagaBaseContext(DatabaseContext<TModel> databaseContext, SagaSerializer<TSaga, TModel> serializer)
        {
