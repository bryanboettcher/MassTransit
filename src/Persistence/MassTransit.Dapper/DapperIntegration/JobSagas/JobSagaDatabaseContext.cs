namespace MassTransit.DapperIntegration.JobSagas
{
    ...
    public class JobSagaDatabaseContext : JobSagaBaseContext<JobSaga, JobSagaDatabaseContext.DbModel>, DatabaseContext<JobSaga>
    {
        public JobSagaDatabaseContext(
            DatabaseContext<DbModel> databaseContext,
            DapperSagaSerializer<JobSaga, DbModel> serializer
        ) : base(databaseContext, serializer)
        { }

        public class Serializer : SystemTextJsonSagaSerializerBase<JobSaga, DbModel>
        {
            public override DbModel FromSaga(JobSaga instance)
            {
            ...
            public override JobSaga? FromModel(DbModel? model)
            {
                if (model is null)
                    return null;
