...
{
    using System;
    using MassTransit.Dapper.Integration.SqlBuilders;
    using MassTransit.Dapper.PostgreSql.Formatting;
    ...
    public class Postgres_PessimisticSqlBuilder_Tests : Postgres_Tests
    {
        ...
        {
            protected ISagaSqlFormatter<VersionedSaga> Subject = new PessimisticPostgresSagaFormatter<VersionedSaga>();
